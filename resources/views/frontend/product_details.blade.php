    	...
    	<div class="container">
            ...
            <div class="container text-center justify-content-center">
                    ...
                    @foreach($imagesGalleries as $imagesGallery)
          					<a href="{{url('/')}}/products/{{$imagesGallery['image']}}" data-standard="{{url('/')}}/products/{{$imagesGallery['image']}}">
          						<img src="{{url('/')}}/products/{{$imagesGallery['image']}}" alt="" width="75" style="padding: 8px;"/>
          					</a>
                    @endforeach
          				</li>
          			</ul>
                          ...
                          <div class="from-group labels row">
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <img src="{{ asset('/images/img_size.jpg') }}" style="width: 100%; height:100%"alt="">
                                  </div>
                            ...
                            <div class="form-group labels row ">
                              ...
                              <div class="col-sm-6 pl-0">
                                <input class="form-control" type="text" name="quantity" value="{{$totalStock}}" id="inputStock"/>
                               </div>
                            </div>
                        <p><b>Availability:</b>
                            @if($totalStock>0)
...
<br>
      ...
      $(".day_rant").change(function(){
        var n_day = $("input[type='radio']:checked").val();

        $('input[name="daterange"]').daterangepicker({
          locale: { format: "DD/MM/YYYY" },
          autoApply: true,
          dateLimit: { days: n_day },
