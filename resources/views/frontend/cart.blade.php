...
@section('content')
         	...
         	<tbody >
         		@foreach(Cart::content() as $row)
                    ...
                    <td>
                        ...
                        <img src="{{url('/')}}/products/{{$row->options->image}}" style="width: 150px; height:180px" class="rounded">
                    </td>
                    <td>
        ...
        <a type="button" class="btn float-sm-right btn-s" href="{{route('check-out.index')}}" name="button">Continue to Checkout</a>
<br><br><br><br>
      @else
